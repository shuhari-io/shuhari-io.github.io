...
For example, if I was teaching a *Shu* stage student how to center clay on the pottery wheel, I would describe a very specific method to practice. I would only teach them one way to do it. I would describe the concepts behind that method, and exactly how to position their hands, but I would not show them a variety of methods. I would want the student to be able to consistently reach the goal, a centered ball of clay, using only one technique.
